...
const DeleteDocument = ( deleteDoc, callback) => {
    ...
    client.connect((err) => {
        ...
        console.log("Connected successfully to server");
        const db = client.db(dbName);
    //const query =  deleteDoc;
    //const
    //console.log(${query});
    db.collection('restaurants').deleteOne(deleteDoc);
...
const handle_Delete = (req, res) => {
    ...
    //form.parse(req, (err, fields, files) => {
        ...
        var deleteDoc1 = {'restaurant_id' : req.body.r_id};
        //deleteDoc1['restaurant_id'] = req.body.resID;
    //console.log(${deleteDoc1});

            DeleteDocument( deleteDoc1, (results) => {
...
app.post('/deletepage', (req,res) => {
	res.status(200).render('deletepage',{r_id: req.body.r_id });
});
...
app.post("/leaflet", (req,res) => {
            ...
            res.render("leaflet", {x: req.body.x, y: req.body.y, zoom:req.query.zoom ? req.query.zoom : 15});
